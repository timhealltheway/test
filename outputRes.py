...
def parse_results(result_file_path):
    ...
    for percentage in range(1, 11):
        ...
        for filename in os.listdir(result_file_path):
            if filename.endswith('.csv') and percentage_str in filename:
...
if __name__ == "__main__":
    ...
    json_directory = 'matrixevaluation/5k_2'
    ...
    # Access the missing index json file
    ...
    # print((orig_mag_values[1]))

    #obtain pred value
    result_file_path = "matrixevaluation/5k_2"
    ...
    # plot_graph(10,error_x, angRes,phase_stands, x_label="Missing Data Rate, %", y_label="Angle difference, degree", title="Phase Angle difference vs Missing Data Rate"
