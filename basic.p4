...
control MyIngress(inout headers hdr,
    ...
    //h3
    register<bit<32>>(3) frac_sec_regs_h3;
    register<bit<32>>(3) soc_regs_h3;
    register<bit<32>>(3) magnitude_regs_h3;
    register<bit<32>>(3) phase_angle_regs_h3;
    register<bit<32>>(3) R1_h3;
